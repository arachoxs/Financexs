# Plan: Requerimientos del Sistema de Gestión de Gastos
...
- No se puede eliminar una cuenta con movimientos asociados (o se deben eliminar/transferir primero)
...
- Dos pestañas/secciones:
  - **Préstamos otorgados**: lista de personas que me deben
  - **Préstamos recibidos**: lista de préstamos que debo
- Acciones por sección:
  - Otorgados: nuevo préstamo, registrar pago recibido
  - Recibidos: nuevo préstamo/cuotas, registrar pago realizado
- Detalle de cada préstamo con historial de pagos
...
### 8.1 Crear `docs/REQUIREMENTS.md`

Crear la carpeta `docs/` y el archivo `docs/REQUIREMENTS.md` con los requerimientos detallados del sistema. Este archivo servirá como referencia principal durante la implementación.

**Contenido del archivo:**
- Resumen ejecutivo del sistema
- Entidades del sistema (8 entidades con sus campos y reglas de negocio)
- Vistas principales (3 vistas)
...
Agregar una sección de referencia al inicio del AGENTS.md para que los agentes sepan dónde encontrar la documentación de requerimientos:
...
### 8.3 Archivos a crear/modificar

1. **Crear**: `docs/REQUIREMENTS.md` - Requerimientos detallados del sistema
2. **Modificar**: `AGENTS.md` - Agregar sección de documentación
